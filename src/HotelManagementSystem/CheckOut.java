...
public class CheckOut extends JFrame {
    ...
    public CheckOut() throws SQLException {
        ...
        Image i3 = i1.getImage().getScaledInstance(800, 294, Image.SCALE_DEFAULT);
        ImageIcon i2 = new ImageIcon(i3);
        JLabel l1 = new JLabel(i2);
        l1.setBounds(0, 0, 800, 294);
        add(l1);
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("newwhms/Icons/tick.png"));
