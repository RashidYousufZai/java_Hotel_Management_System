...
public class dashboard_admin extends JFrame implements ActionListener {
    ...
    JButton a1, a2, a3, b1, b2, b3, c3, b4, b5, b6, b7, b8, b9, b10, b11, b12;
    ...
    public dashboard_admin() {
        ...
        a1 = new JButton("Add Employee");
        a1.setBounds(1100, 350, 250, 50);
        ...
        a2 = new JButton("Add Driver");
        a2.setBounds(1100, 500, 250, 50);
        a2.setFont(new Font("serif", Font.BOLD, 15));
        a2.setBackground(Color.BLACK);
        a2.setForeground(Color.WHITE);
        a2.addActionListener(this);
        l3.add(a2);
        a3 = new JButton("Add Rooom");
        a3.setBounds(1100, 650, 250, 50);
        ...
        l7.setBounds(1160, 160, 1500, 100);
        l7.setFont(new Font("serif", Font.PLAIN, 40));
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == a1) {
            new AddEmployeeAdmin().setVisible(true);
            setVisible(false);

        }
        if (ae.getSource() == a2) {
            new AddDrivers_r().setVisible(true);
            setVisible(false);
