...
public class Custumer_login_info extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    Custumer_login_info frame = new Custumer_login_info();
    ...
    public Custumer_login_info() throws SQLException {
...
//        l1.add(c1);
        JLabel CheckInStatus = new JLabel("Password :");
        CheckInStatus.setFont(new Font("serif", Font.BOLD, 15));
        CheckInStatus.setBackground(Color.WHITE);
        CheckInStatus.setForeground(Color.WHITE);
        CheckInStatus.setBounds(35, 271, 200, 14);
        l1.add(CheckInStatus);
...
//        l1.add(lblDeposite);
        t3 = new JTextField();
        t3.setBounds(150, 231, 150, 20);
        l1.add(t3);
//        t3.setColumns(10);

        t5 = new JTextField();
        t5.setBounds(150, 271, 150, 20);
        l1.add(t5);
//        t5.setColumns(10);
...
//                    String s8 = t6.getText();
                    ...
                    String q1 = "insert into Login_Cust_Info values('" + s1 + "','" + s2 + "','" + s3 + "','" + s4 + "','" + s5 + "','" + s7 + "')";
